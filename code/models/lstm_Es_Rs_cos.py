...
DATA_DIR = "./data/Es_Rc"
DOC_REL_DIR = "./data/relation_through_cosine/"
DOC_REL_PKL = "doc_2_rel_vectors_cosine_sim.pick"
DOC_PKL = "document_list.pick"
TARGET_PKL = "target_list.pick"
DOC_ENTS = "entity_vec_list.pick"

OUTPUT_PATH = './model_outputs/lstm_Es_Rs_cos/'
...
e_attention = entity_attention_model.predict({'main_input':x_test, 'ents':ents_test, 'rels':rels_test}, batch_size=BATCH_SIZE, verbose=0, steps=None)

r_attention = relation_attention_model.predict({'main_input':x_test, 'ents':ents_test, 'rels':rels_test}, batch_size=BATCH_SIZE, verbose=0, steps=None)
